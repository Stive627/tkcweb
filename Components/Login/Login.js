...
function Login() {
    ...
    function handleSubmit(e){
        ...
        .catch(err => {console.log(err.response.data); setErrLog(err.response.data); setPassword(''); setUsernameoremail('')})
    ...
    <Suspense>
        <div className=' flex w-full justify-center px-2'>
            ...
            <form onSubmit={(e) => handleSubmit(e)}  className='flex flex-col gap-3'>
                <TkcInput name='email' type='email' autocomplete='email' placeholder={'Username or email'} value={usernameoremail} handleChange={setUsernameoremail}/>
                <TkcInput name='password' type='password' autocomplete='password' placeholder={'Password'} value={password} handleChange={setPassword}/>
